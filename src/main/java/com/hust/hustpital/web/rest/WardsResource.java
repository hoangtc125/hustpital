...
public class WardsResource {
    ...
    public WardsResource(WardsRepository wardsRepository) {
    ...
    public ResponseEntity<Wards> createWards(@Valid @RequestBody Wards wards) throws URISyntaxException {
        ...
        Wards result = wardsRepository.save(wards);
    ...
    public ResponseEntity<Wards> partialUpdateWards(
        ...
        Optional<Wards> result = wardsRepository
     ...
     */
    @GetMapping("/wards")
    public List<Wards> getAllWards(@RequestParam(required = false, defaultValue = "false") boolean eagerload) {
        log.debug("REST request to get all Wards");
        if (eagerload) {
            return wardsRepository.findAllWithEagerRelationships();
        } else {
    ...
    public ResponseEntity<Wards> getWards(@PathVariable String id) {
        ...
        Optional<Wards> wards = wardsRepository.findOneWithEagerRelationships(id);

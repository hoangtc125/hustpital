...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './doctors.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DOCTORS_LIST actions', async () => {
    ...
    it('dispatches FETCH_DOCTORS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DOCTORS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DOCTORS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DOCTORS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DOCTORS actions', async () => {
      const expectedActions = [
        {

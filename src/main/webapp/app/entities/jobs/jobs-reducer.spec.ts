...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './jobs.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_JOBS_LIST actions', async () => {
    ...
    it('dispatches FETCH_JOBS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_JOBS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_JOBS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_JOBS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_JOBS actions', async () => {
      const expectedActions = [
        {

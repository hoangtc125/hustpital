...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './thong-tin-vao-vien.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_THONGTINVAOVIEN_LIST actions', async () => {
    ...
    it('dispatches FETCH_THONGTINVAOVIEN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_THONGTINVAOVIEN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_THONGTINVAOVIEN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_THONGTINVAOVIEN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_THONGTINVAOVIEN actions', async () => {
      const expectedActions = [
        {

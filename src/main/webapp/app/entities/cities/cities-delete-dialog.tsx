...
export const CitiesDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="hustpitalApp.cities.delete.question">
        <Translate contentKey="hustpitalApp.cities.delete.question" interpolate={{ id: citiesEntity.id }}>

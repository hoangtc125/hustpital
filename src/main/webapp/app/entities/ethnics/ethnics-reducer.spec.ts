...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './ethnics.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ETHNICS_LIST actions', async () => {
    ...
    it('dispatches FETCH_ETHNICS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ETHNICS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ETHNICS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ETHNICS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ETHNICS actions', async () => {
      const expectedActions = [
        {

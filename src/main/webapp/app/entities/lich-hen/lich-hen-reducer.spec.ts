...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './lich-hen.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LICHHEN_LIST actions', async () => {
    ...
    it('dispatches FETCH_LICHHEN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LICHHEN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LICHHEN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LICHHEN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LICHHEN actions', async () => {
      const expectedActions = [
        {

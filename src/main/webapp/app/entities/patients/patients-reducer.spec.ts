...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './patients.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PATIENTS_LIST actions', async () => {
    ...
    it('dispatches FETCH_PATIENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PATIENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PATIENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PATIENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PATIENTS actions', async () => {
      const expectedActions = [
        {

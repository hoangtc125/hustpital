...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CHUYENKHOA_LIST actions', async () => {
    ...
    it('dispatches FETCH_CHUYENKHOA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CHUYENKHOA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CHUYENKHOA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CHUYENKHOA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CHUYENKHOA actions', async () => {
      const expectedActions = [
        {

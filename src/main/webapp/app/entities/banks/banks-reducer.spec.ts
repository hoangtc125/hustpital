...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './banks.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BANKS_LIST actions', async () => {
    ...
    it('dispatches FETCH_BANKS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BANKS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BANKS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BANKS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BANKS actions', async () => {
      const expectedActions = [
        {

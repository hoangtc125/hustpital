...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './wards.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WARDS_LIST actions', async () => {
    ...
    it('dispatches FETCH_WARDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_WARDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_WARDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_WARDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_WARDS actions', async () => {
      const expectedActions = [
        {

...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PHONGKHAM_LIST actions', async () => {
    ...
    it('dispatches FETCH_PHONGKHAM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PHONGKHAM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PHONGKHAM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PHONGKHAM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PHONGKHAM actions', async () => {
      const expectedActions = [
        {

...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LICHLAMVIEC_LIST actions', async () => {
    ...
    it('dispatches FETCH_LICHLAMVIEC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LICHLAMVIEC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LICHLAMVIEC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LICHLAMVIEC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LICHLAMVIEC actions', async () => {
      const expectedActions = [
        {

...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './districts.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DISTRICTS_LIST actions', async () => {
    ...
    it('dispatches FETCH_DISTRICTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DISTRICTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DISTRICTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DISTRICTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DISTRICTS actions', async () => {
      const expectedActions = [
        {

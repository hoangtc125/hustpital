...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './bhyt.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BHYT_LIST actions', async () => {
    ...
    it('dispatches FETCH_BHYT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BHYT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BHYT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BHYT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BHYT actions', async () => {
      const expectedActions = [
        {
